...
public:
    ...
    static const char* KEY_TSPROCESSMODE[];
    static const char KEY_TSPHOTOPROCESSMODE_SUPERRESOLUTION[];
    static const char KEY_TSPHOTOPROCESSMODE_NIGHTPORTRAIT[];
    ...
    friend class QCamera2HardwareInterface;
    bool isTsMode();
...
private:
	...
	int32_t setTsMode(const QCameraParameters& params);
